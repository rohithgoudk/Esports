...
const allTournaments = [
  { id: 1, name: "Ignition Masters",        game: "VALORANT",        prize: "$50,000",  date: "JUL 12–14", teams: 16, slots: 4,  status: "LIVE", genre: "FPS",          accent: "#ff4655", image: ES1 },
  { id: 2, name: "Overdrive Championship",  game: "Counter-Strike 2", prize: "$75,000",  date: "AUG 02–05", teams: 24, slots: 8,  status: "OPEN", genre: "FPS",          accent: "#f0a500", image: ES2 },
  { id: 3, name: "Rift World Cup",           game: "League of Legends",prize: "$100,000", date: "SEP 18–21", teams: 32, slots: 12, status: "OPEN", genre: "MOBA",         accent: "#c89b3c", image: ES3 },
  { id: 4, name: "Apex Strike Series",       game: "Apex Legends",    prize: "$30,000",  date: "AUG 15–17", teams: 20, slots: 6,  status: "OPEN", genre: "Battle Royale", accent: "#cd4129", image: ES4 },
  { id: 5, name: "Dota Arcane Invitational", game: "Dota 2",          prize: "$120,000", date: "OCT 05–08", teams: 16, slots: 0,  status: "FULL", genre: "MOBA",         accent: "#c23c2a", image: ES5 },
  { id: 6, name: "Rocket Rumble Open",       game: "Rocket League",   prize: "$20,000",  date: "JUL 28–30", teams: 32, slots: 14, status: "OPEN", genre: "Sports",        accent: "#0080ff", image: E5  },
];
  ...
  return (
    <div className="trn-page">
      ...
      <section className="trn-hero">
        <div className="trn-hero-bg" style={{ backgroundImage: `url(${featured.image})` }} />
        ...
        <div className="trn-hero-content">
          ...
          <div className="trn-hero-btns">
            <button className="trn-btn-primary" onClick={() => navigate("/404")}>
              Browse Tournaments <IconArrow />
            </button>
            <button className="trn-btn-secondary" onClick={() => navigate("/404")}>
        ...
        <div className="trn-featured-card">
          ...
          <div className="trn-featured-card-body">
            ...
            <button className="trn-btn-primary trn-w-full" onClick={() => navigate("/404")}>
          ...
          {filtered.map((t) => (
            <div className="trn-card" key={t.id}>
              <div className="trn-card-img-wrap">
                ...
                <span className={`trn-card-status ${t.status === "LIVE" ? "trn-live" : t.status === "FULL" ? "trn-full" : "trn-open"}`}>
              ...
              <div className="trn-card-body">
                <div className="trn-card-game-tag" style={{ color: t.accent }}>{t.game}</div>
                ...
                <button
                  ...
                  onClick={() => t.status !== "FULL" && navigate("/404")}
                >
        ...
        <div className="trn-lb-inner">
          ...
          <div className="trn-lb-table">
            <div className="trn-lb-header">
              <span>#</span>
              <span>Team</span>
              <span className="trn-hide-sm">Game</span>
              <span>W</span>
              <span className="trn-hide-sm">L</span>
              <span className="trn-hide-xs">Earnings</span>
            </div>
            {leaderboard.map((row) => (
              <div className={`trn-lb-row ${row.rank <= 3 ? "trn-lb-top" : ""}`} key={row.rank}>
                <span className="trn-lb-rank">
                  {row.rank === 1 && <span>🥇</span>}
                  {row.rank === 2 && <span>🥈</span>}
                ...
                <span className="trn-lb-game trn-hide-sm">{row.game}</span>
                <span className="trn-lb-wins">{row.wins}</span>
                <span className="trn-lb-losses trn-hide-sm">{row.losses}</span>
                <span className="trn-lb-prize trn-hide-xs">{row.prize}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="trn-cta">
        ...
        <div className="trn-cta-content">
          ...
          <div className="trn-cta-btns">
            <button className="trn-btn-primary trn-btn-lg" onClick={() => navigate("/404")}>
              <IconTrophy /> Register Free
            </button>
            <button className="trn-btn-secondary trn-btn-lg" onClick={() => navigate("/404")}>
              View Full Schedule
            </button>
          </div>
